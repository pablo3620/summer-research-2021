...
what if we include cooling degree days in analysis too? unlike this direct avgerage temp vs effiency plot this would allow for cooling and heating in the same month that could reduce effiency. could expalin the couple month that have very bad effiency, possibley have a few cold and warm days but average is nothing unsual 
