...
Figure \ref{fig:vehicle_power_usage} and Figure \ref{fig:vehicle_power_usage_auck} while showing a seasonal trend, shows that the vehicle make up of the fleet can have a much greater impact than anything else on the actual power consumption that EVs will have on the power grid. 
...
Figure \ref{fig:kea_power_usage} and Figure \ref{fig:tui_power_usage} use our consumption model with Flip the Fleets vehicle make up, NZ region weather from 2017 to 2021 and NZTA VKT regional proportions combined with ECCA times models expected passenger EV VKT to estimate total monthly power usage of NZ by passenger EVs for select years between 2018 and 2060. 
