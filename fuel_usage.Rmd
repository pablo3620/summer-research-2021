...
```
```{r}
fuel_trade_cost_series = ts(monthly_trade_cost$est_total_cost, frequency = 12)
...
points(regional_fuel_sales$Total, type = 'l', col = 3)
yearly_line(count = 20)
axis(1, labels = 2005:2021, at = c(0,1:16)*12+1, las = 3)
legend("topleft", legend = c("quaterly data cost estimate", "monthly card purchases"), col = 1:2, lty = 1)
```
