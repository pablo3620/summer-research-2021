...
all of NZ goes from 416 GWh minimum in the summer to 453 GWh maximum
...
minimum in the summer to 577 GWh maximum power usage in the winter.
...
monthly power usage of Auckland goes from 128 GWh minimum in the summer
to 137 GWh maximum power usage in the winter. If the fleet consisted of
heavier less efficient vehicles like the Tesla Model S this would
increase to 167 GWh minimum in the summer to 176 GWh maximum power usage
in the winter.
...
Figure \ref{fig:vehicle_consum} shows comparing flip the fleet
consumption numbers to EECA's times tui model \cite{times_model}
consumption we can see that ECCA's times model is based on a much higher
consumption (lower efficiency) than the flip the fleet data would
suggest. With the consumption model using the flip the fleet vehicle
...
efficient EV. The 2018 times model consumption is much more comparable
to much heavier and less efficient Tesla Model S (based on 81 months of
efficiency data from 5 vehicles).
...
use our consumption model with Flip the Fleets vehicle make up, NZ
