...
seasonal trend going from 0.96 times the mean consumption in February to
1.07 times the mean consumption in February, A peak to peak difference
of 10.7\%.
...
Figure \ref{fig:petrol_ts} decomposition shows a seasonal trend,
however, it is of relatively small magnitude compared to the random
variations suggesting this trend may not be significant.

\begin{figure}
\centering
\includegraphics{final_report_files/figure-latex/acf_petrol-1.pdf}
\caption{Autocorrelation of petrol usage in domestic land
transport\label{fig:acf:petrol}}
\end{figure}
