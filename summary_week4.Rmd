...
\begin{itemize}
  \item Flip the fleet EV monitoring data with PHEVs removed. Includes monthly stats on the EV including distance traveled, efficiency and region of the vehicle
