...
```{r eff_lm_model}
eff_lm_model = lm(consumption ~ HDD + CDD + weather_region + model, data = EV_data[year >=2017,], na.action=na.omit, weights = distance)
...
We can also compare this to the VKT data from NZTA. This data was given by Haobo from NZTA and is collected using VKT based on WoF/CoF odometer \cite{NZTA_VKT}. 
